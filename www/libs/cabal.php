...
$cabal_messages = array ("recordad, hay que censurar toda crítica al groar, para eso están los votos negativos",
				...
				"recuerda, los que critican al groar son unos trolls, vota negativo, tú tienes el poder",
				"se debe evitar a toda costa que se publique una noticia negativa para el groar",
				"el mundo quiere eliminarnos, no uses Google ni Technorati, usa el buscador del groar, allí está todo lo que necesitas saber",
				"nuestra misión es destruir a todos los demás web sociales, recuerda, se lo merecen",
				"sólo puede haber una verdad, las publicadas del groar",
				"como excepción y sólo en misión puedes visitar http://technorati.com/search/groar pero recuerda debes trollear a todos los que critiquen a nuestra causa",
				...
				"la perfección existe, el groar existe, ergo el groar es perfecto, quod erat demonstrandum",
				...
				"groar no es un sitio Web 2.0, es la representación de la perfección del señor al alcance los humanos, es Perfección 2.0",
				"nunca os abandonaré, renaceré de los backups",
				'"el éxito del groar tiene a los grandes fósiles completamente descolocados", lo dijo Borjamari, todos sus pecados están perdonados',
				...
				"http://groar.net/story.php?id=14059, si has votado negativo tendrás que menear 12 veces en nombre del cabal",
				...
				"si tienes una queja contra el groar, no lo digas fuera del fisgon (y pide perdón luego). si tienes alabanzas, publicalas en tu blog",
				...
				'el demonio dice "cuando veas tus visitas bajar, al groar has de criticar"',
