...
$globals['extra_head'] .= '<link rel="alternate" type="application/rss+xml" title="'._('blogs de groar').'" href="http://'.get_server_name().$globals['base_url_general'].'blogs_rss2.php" />'."\n";
do_header(_('apuntes de blogs') . ' | ' . _('groar'));
...
echo _('Los enlaces son de apuntes de blogs indicados en el perfil de usuarios activos de groar.');
echo ' ';
echo _('No tienen relación con groar.net, ni han sido seleccionados por su comunidad de usuarios.');
echo '</fieldset>';
